    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-8 space-y-10 text-white">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
        ...
        <div className="lg:col-span-3 space-y-4">
          ...
          <div className="bg-slate-900/40 border border-white/5 rounded-2xl p-6 shadow-xl space-y-4 min-h-[280px]">
            {isLoading ? (
              ...
              <div className="flex flex-col items-center justify-center h-48 text-center space-y-2">
                ...
                <p className="text-sm text-slate-400">No sessions yet. Start your first discovery above!</p>
              </div>
            ) : (
          ...
          <div className="bg-slate-900/40 border border-white/5 rounded-2xl p-6 shadow-xl space-y-4 min-h-[280px]">
            {isLoading ? (
              ...
              <div className="flex flex-col items-center justify-center h-48 text-center space-y-2">
                ...
                <p className="text-sm text-slate-400">No problem statements generated yet.</p>
              </div>
            ) : (
              <div className="divide-y divide-white/5">
                {topProblems.map((problem) => (
                  ...
                  >
                    <div className="space-y-1 max-w-[70%]">
                      ...
                      <div className="inline-block bg-slate-800 text-slate-400 text-[10px] font-bold px-2 py-0.5 rounded border border-white/5 uppercase tracking-wider">
